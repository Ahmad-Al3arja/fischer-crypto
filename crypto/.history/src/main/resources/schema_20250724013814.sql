...
-- Insert enum values (H2 compatible)
INSERT INTO role (name) VALUES ('USER'), ('ADMIN') ON DUPLICATE KEY UPDATE name = name;
INSERT INTO user_status (name) VALUES ('ACTIVE'), ('INACTIVE'), ('SUSPENDED') ON DUPLICATE KEY UPDATE name = name;
INSERT INTO deposit_status (name) VALUES ('PENDING'), ('APPROVED'), ('REJECTED') ON DUPLICATE KEY UPDATE name = name;
INSERT INTO withdrawal_status (name) VALUES ('PENDING'), ('APPROVED'), ('REJECTED') ON DUPLICATE KEY UPDATE name = name;
INSERT INTO commission_type (name) VALUES ('DIRECT'), ('SECOND_LEVEL') ON DUPLICATE KEY UPDATE name = name;

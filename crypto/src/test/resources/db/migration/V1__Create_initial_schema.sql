-- V1__Create_initial_schema.sql (H2 compatible)
...
-- Add foreign key constraints after table creation (H2 requirement)
ALTER TABLE users ADD CONSTRAINT fk_users_current_plan FOREIGN KEY (current_plan_id) REFERENCES plans(id);
ALTER TABLE users ADD CONSTRAINT fk_users_referrer FOREIGN KEY (referrer_id) REFERENCES users(id);
ALTER TABLE users ADD CONSTRAINT fk_users_grand_referrer FOREIGN KEY (grand_referrer_id) REFERENCES users(id);
...
ALTER TABLE deposits ADD CONSTRAINT fk_deposits_user FOREIGN KEY (user_id) REFERENCES users(id);
...
ALTER TABLE withdrawals ADD CONSTRAINT fk_withdrawals_user FOREIGN KEY (user_id) REFERENCES users(id);
...
ALTER TABLE referral_earnings ADD CONSTRAINT fk_referral_earnings_user FOREIGN KEY (user_id) REFERENCES users(id);
ALTER TABLE referral_earnings ADD CONSTRAINT fk_referral_earnings_referrer FOREIGN KEY (referrer_id) REFERENCES users(id);
...
ALTER TABLE daily_counter ADD CONSTRAINT fk_daily_counter_user FOREIGN KEY (user_id) REFERENCES users(id);

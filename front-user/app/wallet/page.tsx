              ...
              {wallet?.isLocked ? (
                <div className="space-y-4">
                  <Alert>
                    ...
                    <AlertDescription>
                      <strong>Wallet Address Locked:</strong>
                      <ul className="mt-2 space-y-1 text-sm">
                        <li>• Your wallet address has been set and is now locked</li>
                        <li>• You cannot change this address yourself</li>
                        <li>• Contact admin if you need to update your wallet address</li>
                  ...
                  <Alert>
                    ...
                    <AlertDescription>
                      ...
                      <ul className="mt-2 space-y-1 text-sm">
                        ...
                        <li>• <strong>This can only be set once and cannot be changed later</strong></li>
                      </ul>
                    </AlertDescription>
                  </Alert>

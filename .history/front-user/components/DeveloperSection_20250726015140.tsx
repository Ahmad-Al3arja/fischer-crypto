import { ExternalLink, MessageCircle, Heart, User } from 'lucide-react'
    ...
    <div className="w-full bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 border-t border-gray-600 py-8 px-4 mb-16">
      <div className="max-w-lg mx-auto">
        <div className="bg-gradient-to-br from-gray-800 via-gray-700 to-gray-800 border border-gray-600 rounded-2xl shadow-xl p-8">
          {/* Header with avatar and text - Enhanced for better attention */}
          <div className="flex flex-col items-center text-center mb-8">
            {/* Developer avatar - Text-based instead of image */}
            <div className="relative w-32 h-32 rounded-full border-4 border-green-500 shadow-2xl flex-shrink-0 mb-6 transform hover:scale-105 transition-transform duration-300 bg-gradient-to-br from-green-600 to-green-400 flex items-center justify-center">

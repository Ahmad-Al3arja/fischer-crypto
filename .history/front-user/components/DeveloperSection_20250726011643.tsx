        ...
        <div className="bg-gradient-to-br from-gray-800 via-gray-700 to-gray-800 border border-gray-600 rounded-xl shadow-lg p-4">
          ...
          <div className="flex items-center space-x-3 mb-3">
            ...
            <div className="flex-1 min-w-0">
              <h3 className="text-white font-bold text-base leading-tight tracking-wide mb-1">Ahmed Alarjah</h3>
              <p className="text-green-400 text-sm font-medium tracking-wide mb-1">Full Stack Developer</p>

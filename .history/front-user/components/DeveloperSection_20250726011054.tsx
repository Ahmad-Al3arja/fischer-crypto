    ...
    <div className="fixed bottom-6 right-6 z-50">
      <div className="bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 border border-gray-600 rounded-2xl shadow-2xl p-6 max-w-sm backdrop-blur-sm">
        ...
        <div className="flex items-start space-x-4 mb-4">
          <div className="relative w-20 h-20 rounded-full overflow-hidden border-3 border-green-500 shadow-lg flex-shrink-0">
            <Image
          ...
          <div className="flex-1 min-w-0">
            <h3 className="text-white font-bold text-lg leading-tight tracking-wide mb-1">Ahmed Alarjah</h3>
            <p className="text-green-400 text-sm font-medium tracking-wide mb-2">Full Stack Developer</p>
            <div className="flex items-center">
              <div className="w-2 h-2 bg-green-500 rounded-full mr-2 animate-pulse"></div>
              <span className="text-gray-400 text-xs tracking-wide">Available for projects</span>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-4">
          <button
            ...
            className="w-full bg-gradient-to-r from-green-600 via-green-500 to-green-600 hover:from-green-500 hover:via-green-400 hover:to-green-500 text-white text-sm font-semibold py-3 px-4 rounded-xl flex items-center justify-center space-x-3 transition-all duration-300 transform hover:scale-105 hover:shadow-lg shadow-md tracking-wide"
          >

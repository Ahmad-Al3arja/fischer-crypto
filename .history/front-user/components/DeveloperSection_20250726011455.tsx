...
export default function DeveloperSection() {
  ...
  return (
    <div className="w-full bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 border-t border-gray-600 py-6 px-4">
      <div className="max-w-md mx-auto">
        <div className="bg-gradient-to-br from-gray-800 via-gray-700 to-gray-800 border border-gray-600 rounded-2xl shadow-2xl p-6 backdrop-blur-sm">

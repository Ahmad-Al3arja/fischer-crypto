        ...
        <div className="w-full max-w-6xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
          <div className="flex flex-wrap items-center justify-between gap-2 mb-6">
            ...
            <div className="flex flex-col sm:flex-row gap-2 w-full sm:w-auto">
              ...
              <Link href="/dashboard">
                <Button variant="outline" className="flex items-center space-x-2 bg-card border-border hover:bg-muted w-full">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-6 mb-8 w-full">
            {plans && plans.length > 0 ? (
              plans.map((plan) => (
                <Card key={plan.id} className="bg-card border-border hover:shadow-lg transition-shadow w-full">
          ...
          <Card className="mt-8 bg-gradient-to-r from-primary to-primary/80 text-primary-foreground">
            <CardHeader className="text-center">
              <CardTitle className="text-primary-foreground">{t('investment_process')}</CardTitle>
              <CardDescription className="text-primary-foreground/80 mb-6 max-w-2xl mx-auto">
                {t('join_thousands')}
              </CardDescription>
            </CardHeader>

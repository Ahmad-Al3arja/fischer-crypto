                ...
                <Card key={plan.id} className="bg-card border-border hover:shadow-lg transition-shadow">
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="text-center p-3 bg-muted rounded-lg">
                      ...
                      <p className="text-sm text-muted-foreground mb-1">Daily Profit Range</p>
                      <p className="font-semibold text-foreground">
                        {plan.dailyProfitMin.toFixed(1)}% - {plan.dailyProfitMax.toFixed(1)}%
                      </p>
                      <p className="text-xs text-muted-foreground mt-1">
                        Avg: {plan.dailyProfit.toFixed(1)}%
                      </p>
                    </div>
                    ...
                    <div className="text-center p-3 bg-primary/10 rounded-lg">
                      ...
                      <p className="text-xl font-bold text-primary">${plan.monthlyProfit.toLocaleString()}</p>
                      <p className="text-xs text-muted-foreground mt-1">
                        {((plan.monthlyProfit / plan.price) * 100).toFixed(1)}% Return
                      </p>
                    </div>

              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <Button size="sm" onClick={() => {navigator.clipboard.writeText(getReferralLink()); toast({title: "Copied!", description: "Referral link copied to clipboard"})}} className="flex-shrink-0 bg-gradient-to-r from-gray-700 to-gray-800 hover:from-gray-600 hover:to-gray-700 text-white">
                      <Copy className="h-4 w-4" />
                    </Button>
                  </div>
                      </div>

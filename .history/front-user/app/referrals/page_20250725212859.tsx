  ...
  const fetchReferralData = async () => {
    try {
      ...
      if (data) {
        ...
        setApiError("Failed to load referral data from database. Showing demo data.")
      }
    } catch (err: any) {
      console.error("Error in fetchReferralData:", err)
      setApiError("Failed to load referral data. Please try again later.")
        ...
        <div className="max-w-6xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
            ...
            <Card className="bg-card border-border">
              <CardContent className="pt-4">
                <div className="text-center">
                  ...
                  <p className="text-sm text-muted-foreground mb-1">Second Level</p>
          ...
          <Card className="mb-6 bg-card border-border">
              ...
              <CardDescription className="text-muted-foreground">
                Share your referral code with friends and earn up to 12% commission on their deposits
              </CardDescription>
                </CardHeader>
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  <Label className="text-sm font-medium text-foreground">Referral Code</Label>
                    <div className="flex items-center space-x-2">
                    <div className="flex-1 p-3 bg-muted rounded-lg font-mono text-center text-foreground">
                      {referralStats.referralCode}
                    </div>
                    <Button size="sm" onClick={copyReferralCode} className="flex-shrink-0 bg-primary hover:bg-primary/90 text-primary-foreground">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center space-x-2">
                    <div className="flex-1 p-3 bg-muted rounded-lg font-mono text-sm truncate text-foreground">
                      {referralStats.referralLink}
                    </div>
                    <Button size="sm" onClick={copyReferralLink} className="flex-shrink-0 bg-primary hover:bg-primary/90 text-primary-foreground">
                      <Copy className="h-4 w-4" />
                    </Button>
                  </div>
                      </div>
              ...
              <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg">
                ...
                <ul className="text-sm text-blue-800 space-y-1">
                  ...
                  <li>• You earn 12% commission on their deposits (Direct)</li>
                  <li>• You earn 6% commission on their referrals' deposits (Second Level)</li>
              ...
              {referralUsers.length === 0 ? (
                <div className="text-center py-8">
                  ...
                  <div className="flex items-center justify-center space-x-2">
                    ...
                    <Button size="sm" onClick={copyReferralCode} className="bg-primary hover:bg-primary/90 text-primary-foreground">
                      <Copy className="h-4 w-4" />
                    </Button>
                  </div>
                </div>
                  ...
                  <Table>
                    <TableHeader>
                      <TableRow>
                        ...
                        <TableHead className="text-foreground">Total Deposits</TableHead>
                        <TableHead className="text-foreground">Commission Earned</TableHead>
                      </TableRow>
                    </TableHeader>
                    <TableBody>

    ...
    try {
      ...
      if (data) {
        ...
        const validStats = {
          ...
          referralCode: data.stats?.referralCode || "DEMO123",
          referralLink: data.stats?.referralLink || "https://fischer.com/register?ref=DEMO123"
        }
        
        const validUsers = Array.isArray(data.referrals) ? data.referrals : []

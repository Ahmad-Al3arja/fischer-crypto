        ...
        <div className="fixed bottom-0 left-0 right-0 bg-gradient-to-r from-gray-900 to-gray-800 border-t border-gray-700 z-[9999]">
          <div className="flex justify-around py-3">
            <Link href="/dashboard" className="flex flex-col items-center space-y-1 p-2">
              <Home className="h-5 w-5" style={{ color: '#2E2E2E' }} />
              <span className="text-xs" style={{ color: '#2E2E2E' }}>{t('home')}</span>
            </Link>
            <Link href="/plans" className="flex flex-col items-center space-y-1 p-2">
              <BarChart3 className="h-5 w-5" style={{ color: '#2E2E2E' }} />
              <span className="text-xs" style={{ color: '#2E2E2E' }}>{t('investment')}</span>
            </Link>
            <Link href="/wallet" className="flex flex-col items-center space-y-1 p-2">
              <Wallet className="h-5 w-5" style={{ color: '#2E2E2E' }} />
              <span className="text-xs" style={{ color: '#2E2E2E' }}>{t('wallet')}</span>
            </Link>
            <Link href="/referrals" className="flex flex-col items-center space-y-1 p-2">
              <Users className="h-5 w-5" style={{ color: '#2E2E2E' }} />
              <span className="text-xs" style={{ color: '#2E2E2E' }}>{t('referrals')}</span>
            </Link>
            <Link href="/profile" className="flex flex-col items-center space-y-1 p-2">
              <ProfileIcon className="h-5 w-5" style={{ color: '#2E2E2E' }} />
              <span className="text-xs" style={{ color: '#2E2E2E' }}>{t('profile')}</span>
            </Link>
          </div>
        </div>

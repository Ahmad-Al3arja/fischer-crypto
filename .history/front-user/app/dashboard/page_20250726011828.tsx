  ...
  return (
    <ProtectedRoute>
      <div className="min-h-screen bg-black">
        ...
        <div className="max-w-4xl mx-auto py-6 px-4 sm:px-6 lg:px-8 pb-32">
          ...
          {dashboardData && (
            <>
              ...
              <Card className="mb-6 bg-gradient-to-br from-gray-800 to-gray-900 border-gray-700 shadow-lg">
                ...
                <CardContent>
                  <div className="flex flex-col items-center space-y-4">
                    <div className={`w-32 h-32 rounded-full border-4 ${getTimerColor(displayTimeSeconds)} flex items-center justify-center bg-gradient-to-br from-gray-800 to-gray-900 relative`}>
                      {/* Progress ring */}
                    ...
                    {timerDisplayState === "no-plan" && (
                      <div className="text-center space-y-2">
                        ...
                        <Link href="/plans">
                          <Button className="bg-gradient-to-r from-gray-700 to-gray-800 hover:from-gray-600 hover:to-gray-700 text-white">
                    ...
                    {timerDisplayState === "completed" && (
                      <div className="space-y-2 w-full">
                        ...
                        <Button
                          onClick={handleActivateCounter}
                          disabled={counterLoading}
                          className="bg-gradient-to-r from-gray-700 to-gray-800 hover:from-gray-600 hover:to-gray-700 text-white w-full"
                        >
                          {counterLoading ? (
                            <div className="flex items-center space-x-2">
                              <div className="animate-spin rounded-full h-4 w-4 border-b-2 border-current"></div>
              ...
              <div className="grid grid-cols-2 gap-4 mb-6">
                <Link href="/deposit">
                  <Button className="w-full h-16 sm:h-20 flex flex-col items-center justify-center space-y-2 bg-gradient-to-br from-gray-800 to-gray-900 border-gray-700 hover:from-gray-700 hover:to-gray-800 shadow-lg">
                    <TrendingUp className="h-5 w-5 sm:h-6 sm:w-6 text-white" />
                    <span className="text-xs sm:text-sm font-medium text-white">Deposit</span>
                  </Button>
                </Link>
                ...
                <Link href="/withdraw">
                  <Button className="w-full h-16 sm:h-20 flex flex-col items-center justify-center space-y-2 bg-gradient-to-br from-gray-800 to-gray-900 border-gray-700 hover:from-gray-700 hover:to-gray-800 shadow-lg">
                    ...
                    <span className="text-xs sm:text-sm font-medium text-white">Withdraw</span>
                  </Button>
                </Link>

                <Link href="/profile" className="flex flex-col items-center justify-center p-4 bg-gradient-to-br from-gray-800 to-gray-900 border-gray-700 hover:from-gray-700 hover:to-gray-800 shadow-lg rounded-lg transition-all duration-200 text-white">
                ...
                <Link href="/withdrawal-history">
                  <Button className="w-full h-16 sm:h-20 flex flex-col items-center justify-center space-y-2 bg-gradient-to-br from-gray-800 to-gray-900 border-gray-700 hover:from-gray-700 hover:to-gray-800 shadow-lg">
                    ...
                    <span className="text-xs sm:text-sm font-medium text-white">Transactions</span>
                  </Button>
                </Link>
              </div>
            </>
        ...
        <div className="fixed bottom-0 left-0 right-0 bg-gradient-to-r from-gray-900 to-gray-800 border-t border-gray-700 z-[9999]">

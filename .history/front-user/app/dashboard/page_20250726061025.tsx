  ...
  return (
    <ProtectedRoute>
            ...
            <>
              ...
              {/* Balance Cards */}
                ...
                <Card className="bg-gradient-to-br bg-card border-border shadow-lg">
                  <CardContent className="pt-4">
                    <div className="text-center">
                      <p className="text-sm text-muted-foreground mb-1">{t('total_profit')}</p>
                ...
                <Card className="bg-gradient-to-br bg-card border-border shadow-lg">
                  <CardContent className="pt-4">
                    <div className="text-center">
                      <p className="text-sm text-muted-foreground mb-1">{t('todays_profit')}</p>
              ...
              <Card className="mb-6 bg-gradient-to-br bg-card border-border shadow-lg">
                  ...
                  <div className="flex flex-col items-center space-y-4">
                    ...
                    {timerDisplayState === "no-plan" && (
                      <div className="text-center space-y-2">
                        ...
                        <Link href="/plans">
                          <Button className="bg-gradient-to-r from-gray-700 to-custom-2e2e2e hover:from-gray-600 hover:to-gray-700 text-foreground">
                    ...
                    {timerDisplayState === "completed" && (
                      <div className="space-y-2 w-full">
                        ...
                        <Button
                          onClick={handleActivateCounter}
                          disabled={counterLoading}
                          className="bg-gradient-to-r from-gray-700 to-custom-2e2e2e hover:from-gray-600 hover:to-gray-700 text-foreground w-full"
                        >
                          {counterLoading ? (
                            <div className="flex items-center space-x-2">
                              <div className="animate-spin rounded-full h-4 w-4 border-b-2 border-current"></div>
               ...
               <div className="grid grid-cols-2 gap-4 mb-6">
                 <Link href="/deposit">
                   <Button className="w-full h-16 sm:h-20 flex flex-col items-center justify-center space-y-2 bg-gradient-to-br bg-card border-border hover:from-gray-700 hover:to-custom-2e2e2e shadow-lg">
                 ...
                 <Link href="/profile">
                   <Button className="w-full h-16 sm:h-20 flex flex-col items-center justify-center space-y-2 bg-gradient-to-br bg-card border-border hover:from-gray-700 hover:to-custom-2e2e2e shadow-lg">
                     ...
                     <span className="text-xs sm:text-sm font-medium text-foreground">{t('about')}</span>
                   </Button>
                 </Link>
                 ...
                 <Link href="/withdrawal-history">
                   <Button className="w-full h-16 sm:h-20 flex flex-col items-center justify-center space-y-2 bg-gradient-to-br bg-card border-border hover:from-gray-700 hover:to-custom-2e2e2e shadow-lg">
                     ...
                     <span className="text-xs sm:text-sm font-medium text-foreground">{t('transactions')}</span>
                   </Button>
                 </Link>
               </div>
            </>
        ...
        {/* Bottom Navigation Bar */}
                  <div className="fixed bottom-0 left-0 right-0 bg-background border-t border-border shadow-lg z-[9999]">
          <div className="flex justify-around py-3">
                         <Link href="/dashboard" className="flex flex-col items-center space-y-1 p-2">
               <Home className="h-5 w-5 text-foreground" />
               <span className="text-xs text-foreground">{t('home')}</span>
             </Link>
             ...
             <Link href="/referrals" className="flex flex-col items-center space-y-1 p-2">
               ...
               <span className="text-xs text-foreground">{t('referrals')}</span>
             </Link>

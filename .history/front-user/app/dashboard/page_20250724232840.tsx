...
export default function DashboardPage() {
  ...
  const handleActivateCounter = async () => {
    ...
    try {
      ...
      setCountdown(86400) // Reset to 24 hours
            ...
            <>
              ...
              <Card className="mb-8 bg-card border-border">
                ...
                <CardContent>
                      ...
                      <div className="relative w-32 h-32 mx-auto mb-4">
                        <svg className="w-32 h-32 transform -rotate-90" viewBox="0 0 120 120">
                          ...
                          <circle
                            ...
                            strokeDashoffset={`${2 * Math.PI * 54 * (1 - getProgressPercentage(countdown) / 100)}`}
                  ...
                  {!isTimerActive && countdown === 0 && (
                    <div className="text-center py-8">
                      <p className="text-muted-foreground mb-4">Timer completed! You can activate it again.</p>
                      <Button 
                        onClick={handleActivateCounter} 
                        disabled={counterLoading}
                        className="bg-primary hover:bg-primary/90 text-primary-foreground btn-animate"

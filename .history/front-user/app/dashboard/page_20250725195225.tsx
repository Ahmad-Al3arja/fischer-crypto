...
export default function DashboardPage() {
  ...
  useEffect(() => {
    ...
    // If timer is active but no remaining seconds, start from 24 hours
    ...
    } else if (dashboardData.counterStatus.remainingSeconds > 0) {
      console.log("Setting timer from backend data:", dashboardData.counterStatus.remainingSeconds)
    ...
    const interval = setInterval(() => {
      setLocalRemainingSeconds(prev => {
        ...
        if (prev <= 1) {
          ...
          console.log("Timer completed, refreshing dashboard")
          fetchDashboardData()
          return 0
        }
        return prev - 1

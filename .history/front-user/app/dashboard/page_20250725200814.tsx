...
export default function DashboardPage() {
  ...
  }, [dashboardData?.counterStatus.isActive])
  ...
  useEffect(() => {
    ...
    // If backend shows timer is active, sync with backend data
    if (dashboardData?.counterStatus.isActive && dashboardData?.counterStatus.remainingSeconds > 0) {
      console.log("Syncing with backend timer:", dashboardData.counterStatus.remainingSeconds)
    ...
    // Start countdown from 24 hours if timer is running locally but not synced with backend
  ...
  }, [isTimerRunning, localRemainingSeconds, dashboardData?.counterStatus.isActive, dashboardData?.counterStatus.remainingSeconds])
  ...
  const handleActivateCounter = async () => {
    ...
    try {
      ...
      // Timer will be synced with backend data in the useEffect
      toast({
        title: "Success!",
              ...
              <Card className="mb-6 bg-card border-border">
                ...
                <CardContent>
                  <div className="flex flex-col items-center space-y-4">
                    ...
                    {dashboardData.currentPlanName && !isTimerRunning && (

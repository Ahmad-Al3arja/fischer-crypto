...
export default function DashboardPage() {
  ...
  const fetchDashboardData = useCallback(async () => {
    try {
      ...
      if (data.counterStatus) {
        ...
        setIsTimerActive(isActive && !isCompleted)
        ...
        console.log("Updated local timer state:", { 
          isTimerActive: isActive && !isCompleted, 
  ...
  const getTimerDisplayState = () => {
    ...
    if (counterStatus.isActive && !counterStatus.isCompleted) return "active"
    if (counterStatus.isCompleted) return "completed"
    if (!counterStatus.isActive && !counterStatus.isCompleted) return "inactive"

              ...
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <div className="text-center p-6 bg-gradient-to-r from-gray-700 to-gray-800 rounded-lg border border-gray-600">
                    ...
                    <p className="text-sm text-gray-300 mb-1">{t('minimum_deposit_label')}</p>
                  ...
                  <div className="text-center p-6 bg-gradient-to-r from-gray-700 to-gray-800 rounded-lg border border-gray-600">
                    ...
                    <p className="text-sm text-gray-300 mb-1">{t('maximum_deposit_label')}</p>
                  ...
                  <div className="text-center p-6 bg-gradient-to-r from-gray-700 to-gray-800 rounded-lg border border-gray-600">
                    ...
                    <p className="text-sm text-gray-300 mb-1">{t('processing_time_label')}</p>

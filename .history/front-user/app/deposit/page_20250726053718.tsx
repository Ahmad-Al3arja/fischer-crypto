                  ...
                  {selectedPlan && (
                    <div className="space-y-2">
                      ...
                      <p className="text-xs text-muted-foreground font-medium">
                        Min: <span className="text-green-400 font-bold">${selectedPlan.minAmount}</span> &nbsp;|&nbsp; Max: <span className="text-gray-600 font-bold">${selectedPlan.maxAmount}</span>
                      </p>
                    </div>
                  )}
                ...
                <CardContent>
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center justify-between p-3 bg-gradient-to-r from-gray-700 to-gray-800 rounded-lg">
                      ...
                      <span className="text-gray-600 font-bold text-lg">{selectedPlan.duration} {t('days')}</span>
                    </div>

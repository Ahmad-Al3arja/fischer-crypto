                  ...
                  {selectedPlan && (
                    <div className="space-y-2">
                      ...
                      <p className="text-xs text-muted-foreground font-medium">
                        Min: <span className="text-green-400 font-bold">${selectedPlan.minAmount}</span> &nbsp;|&nbsp; Max: <span className="text-gray-400 font-bold">${selectedPlan.maxAmount}</span>
                      </p>
                    </div>
                  )}
                ...
                <CardContent>
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center justify-between p-3 bg-gradient-to-r from-gray-700 to-gray-800 rounded-lg">
                      ...
                      <span className="text-gray-400 font-bold text-lg">{selectedPlan.duration} {t('days')}</span>
                    </div>
              ...
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  ...
                  <div className="text-center p-6 bg-gradient-to-r from-gray-700 to-gray-800 rounded-lg border border-gray-600">
                    ...
                    <p className="text-gray-400 font-bold text-lg">${depositInfo.maxDeposit.toLocaleString()}</p>
                  </div>
                  <div className="text-center p-6 bg-gradient-to-r from-gray-700 to-gray-800 rounded-lg border border-gray-600">

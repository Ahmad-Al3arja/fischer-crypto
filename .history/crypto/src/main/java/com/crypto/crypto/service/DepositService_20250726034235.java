...
public class DepositService {
    ...
    public void approveDeposit(Long depositId) {
        ...
        user.setFrozenBalance(user.getFrozenBalance().add(deposit.getAmount())); // FREEZE THE DEPOSIT AMOUNT
    ...
    public long getPendingDepositsCount() {
        return depositRepository.countByStatus(DepositStatus.PENDING);
    }

    public BigDecimal getTotalDeposited() {
        return depositRepository.findByStatus(DepositStatus.APPROVED)
                .stream()

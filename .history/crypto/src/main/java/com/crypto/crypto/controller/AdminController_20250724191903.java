...
public class AdminController {
    ...
    public ResponseEntity<?> getDefaultUsageLimit() {
        try {
            String defaultLimit = adminSettingsService.getSettingValue("default_promo_usage_limit");
            int limit = defaultLimit != null ? Integer.parseInt(defaultLimit) : 100;
    ...
    public ResponseEntity<?> updateDefaultUsageLimit(@RequestBody DefaultUsageLimitRequest request) {
        try {
            ...
            adminSettingsService.setSetting("default_promo_usage_limit", String.valueOf(request.getUsageLimit()), "Default usage limit for new promo codes");

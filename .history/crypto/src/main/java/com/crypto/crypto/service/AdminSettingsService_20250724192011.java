...
public class AdminSettingsService {
    ...
    public void updateDefaultUsageLimit(int usageLimit) {
        setSetting("default_promo_usage_limit", String.valueOf(usageLimit), "Default usage limit for new promo codes");
    }
    
    public int getDefaultUsageLimit() {
        String value = getSettingValue("default_promo_usage_limit");

...
public class UserDTOs {
    ...
    public static class DetailedReferralResponse {
        private List<DetailedReferralInfo> directReferrals;
        private List<DetailedReferralInfo> secondLevelReferrals;
        private int totalDirectCount;
        private int totalSecondLevelCount;
        private BigDecimal totalReferralEarnings;
        
        // Getters and Setters
        public List<DetailedReferralInfo> getDirectReferrals() { return directReferrals; }
        public void setDirectReferrals(List<DetailedReferralInfo> directReferrals) { this.directReferrals = directReferrals; }
        
        public List<DetailedReferralInfo> getSecondLevelReferrals() { return secondLevelReferrals; }
        public void setSecondLevelReferrals(List<DetailedReferralInfo> secondLevelReferrals) { this.secondLevelReferrals = secondLevelReferrals; }
        
        public int getTotalDirectCount() { return totalDirectCount; }
        public void setTotalDirectCount(int totalDirectCount) { this.totalDirectCount = totalDirectCount; }
        
        public int getTotalSecondLevelCount() { return totalSecondLevelCount; }
        public void setTotalSecondLevelCount(int totalSecondLevelCount) { this.totalSecondLevelCount = totalSecondLevelCount; }
        
        public BigDecimal getTotalReferralEarnings() { return totalReferralEarnings; }
        public void setTotalReferralEarnings(BigDecimal totalReferralEarnings) { this.totalReferralEarnings = totalReferralEarnings; }
    }

    public static class DetailedReferralInfo {
        private Long id;
        private String username;
        private String fullName;
        private String phoneNumber;
    ...
    public static class ReferralEarningsHistoryResponse {
        private List<ReferralEarningDetail> earnings;
        private BigDecimal totalEarnings;
        
        public ReferralEarningsHistoryResponse(List<ReferralEarningDetail> earnings, BigDecimal totalEarnings) {
            this.earnings = earnings;
            this.totalEarnings = totalEarnings;
        }
        
        public List<ReferralEarningDetail> getEarnings() { return earnings; }
        public void setEarnings(List<ReferralEarningDetail> earnings) { this.earnings = earnings; }
        
        public BigDecimal getTotalEarnings() { return totalEarnings; }
        public void setTotalEarnings(BigDecimal totalEarnings) { this.totalEarnings = totalEarnings; }
    }

    public static class ReferralEarningDetail {
        private Long id;
        private String referredUsername;
        private String referredFullName;
        ...
        public String getReferredFullName() { return referredFullName; }
        public void setReferredFullName(String referredFullName) { this.referredFullName = referredFullName; }
    ...
    public static class TeamEarningsBreakdown {
        private BigDecimal totalDirectEarnings;
        private BigDecimal totalGrandEarnings;
        private int directReferrals;
        private int grandReferrals;
        private List<ReferralDetail> directReferralDetails;
        private List<ReferralDetail> grandReferralDetails;

        // Getters and Setters
        public BigDecimal getTotalDirectEarnings() { return totalDirectEarnings; }
        public void setTotalDirectEarnings(BigDecimal totalDirectEarnings) { this.totalDirectEarnings = totalDirectEarnings; }
        public BigDecimal getTotalGrandEarnings() { return totalGrandEarnings; }
        public void setTotalGrandEarnings(BigDecimal totalGrandEarnings) { this.totalGrandEarnings = totalGrandEarnings; }
        public int getDirectReferrals() { return directReferrals; }
        public void setDirectReferrals(int directReferrals) { this.directReferrals = directReferrals; }
        public int getGrandReferrals() { return grandReferrals; }
        public void setGrandReferrals(int grandReferrals) { this.grandReferrals = grandReferrals; }
        public List<ReferralDetail> getDirectReferralDetails() { return directReferralDetails; }
        public void setDirectReferralDetails(List<ReferralDetail> directReferralDetails) { this.directReferralDetails = directReferralDetails; }
        public List<ReferralDetail> getGrandReferralDetails() { return grandReferralDetails; }
        public void setGrandReferralDetails(List<ReferralDetail> grandReferralDetails) { this.grandReferralDetails = grandReferralDetails; }
    }
} 
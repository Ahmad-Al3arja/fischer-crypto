...
public class UserService {
    ...
    public AuthDTOs.AuthResponse register(AuthDTOs.RegisterRequest request) {
        ...
        try {
            ...
            // 6. Check referral usage limit with error handling (temporarily disabled)
            System.out.println("[register] Skipping referral usage check for now");
            /*
            try {
            ...
            */
            ...
            try {
                ...
                // Temporarily disable referral system to fix registration
            ...
            // 11. Increment referral usage count (non-critical, in separate transaction)
            incrementReferralUsage(referrer);

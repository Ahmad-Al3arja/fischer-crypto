...
public class TransactionController {
    ...
    public ResponseEntity<?> getDepositHistory() {
        try {
            TransactionDTOs.DepositHistoryResponse response = depositService.getDepositHistory();
            return ResponseEntity.ok(response);
        } catch (Exception e) {
            return ResponseEntity.badRequest().body(new ErrorResponse(e.getMessage()));
        }
    ...
    public ResponseEntity<?> getWithdrawalHistory() {
        try {
            TransactionDTOs.WithdrawalHistoryResponse response = withdrawalService.getWithdrawalHistory();
            return ResponseEntity.ok(response);
        } catch (Exception e) {
            return ResponseEntity.badRequest().body(new ErrorResponse(e.getMessage()));
        }

        ...
        {requests.length === 0 ? (
          <Card>
            <CardContent className="flex flex-col items-center justify-center py-8">
              ...
              <h3 className="text-lg font-semibold mb-2">No Wallet Requests</h3>
              ...
              <CardHeader>
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-3">
                    ...
                    <span className="text-sm text-muted-foreground">{request.userPhone}</span>
                  </div>
                ...
                <div className="space-y-4">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <p className="font-mono text-sm break-all">{request.currentAddress}</p>
                    </div>
                    <div>
                      <p className="text-sm font-medium text-muted-foreground">New Address</p>
                      <p className="font-mono text-sm break-all">{request.newAddress}</p>
                    </div>
                  </div>
                  <div>
